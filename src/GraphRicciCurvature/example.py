...
# nx.write_gexf(G,"club_graph_1.gexf")
...
# G = nx.karate_club_graph()
# orc_Sinkhorn = OllivierRicci(G, alpha=0.5, method="OTD", verbose="INFO")
# orc_Sinkhorn.compute_ricci_flow(iterations=10)
# nx.write_gml(G,"club_graph_2.gml")
...
# orc_Sinkhorn = OllivierRicci(G, alpha=0.5, method="OTD", verbose="INFO")
# orc_Sinkhorn.compute_ricci_flow(iterations=20, surgery=(my_surgery, 2))
